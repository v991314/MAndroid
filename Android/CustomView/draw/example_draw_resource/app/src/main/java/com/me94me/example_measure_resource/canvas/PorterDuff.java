...
package com.me94me.example_measure_resource.canvas;
...
public class PorterDuff {
    ...
    public enum Mode {
         ...
         * </p>
         * <p>\(\alpha_{out} = \alpha_{src}\)</p>//输出源图的alpha
         * <p>\(C_{out} = C_{src}\)</p>//输出源图的颜色
         * 源图
         */
        SRC         (1),
        /**
         ...
         * </p>
         * <p>\(\alpha_{out} = \alpha_{dst}\)</p>//目标图像的alpha
         * <p>\(C_{out} = C_{dst}\)</p>//目标图像的颜色
         * 目标图像
         */
        DST         (2),
        /**
