...
/**
 * 用于动态类型化数据值的容器。
 * 主要与{@link android.content.res.Resources}一起用于保存资源值
 */
public class TypedValue {
    /** 该值不包含任何数据 */
    public static final int TYPE_NULL = 0x00;

    /** <var>data</var>字段包含资源标识符。 */
    ...
    /**
     * <var>string</var> field 持有String数据
     *
     * 此外，如果<var>data</var>不为0，data就作为string模块的index
     *
     * <var>assetCookie</var>作为string来源的数据集
     */
    ...
    /**
     * 此值保存的类型，由常量定义，比如{@link #TYPE_STRING}
     * 这将告诉您如何解释对象中的其他字段
     */
    public int type;
    ...
    /**
     * 如果值来自resource，则这些是其内容可以更改的配置。
     *
     * 例如，如果资源具有为-land资源限定符定义的值，则此字段将设置{@link android.content.pm.ActivityInfo＃CONFIG_ORIENTATION}位
     *
