...
public class BinderInternal {
     ...
     *
     * Java层的ServiceManager需要在Native层获取指向native层的ServiceManager的BpProxy
     * 这个BpProxy不能由Java层ServiceManager直接调用，于是通过封装了这个BpProxy的对象BinderProxy返回给ServiceManager，ServiceManager通过这个对象对BpProxy的访问
     *
     * Return the global "context object" of the system.
     * This is usually an implementation of IServiceManager, which you can use to find other services.
     */
