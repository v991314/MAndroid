...
public class Binder implements IBinder {
    ...
    /**
     * 指向native层JavaBBinderHolder对象
     *
     * native层的JavaBBinderHolder对象通过mBinder成员指向一个native的JavaBBinder对象
     * native层的JavaBBinder对象又通过mObject变量指向Java层的binder对象
 ...
 * Allocated and constructed by the native javaObjectforIBinder function. Never allocated directly from Java code.
 */
final class BinderProxy implements IBinder {
    ...
    /**
     * 发送给JNI层的Binder，通过JNI层的Binder进行通信
     */
